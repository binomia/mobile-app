...
const BankingStack: React.FC = () => {
    ...
    return (
        <Stack.Navigator initialRouteName='BankingScreen' screenOptions={{ headerTintColor: colors.white }} >
            <Stack.Screen name='BankingScreen' options={{ headerRight, headerBackTitle: 'atras', title: 'Deposito & Retiros', ...headerStyles }} component={BankingScreen} />
        </Stack.Navigator >
    )
}
